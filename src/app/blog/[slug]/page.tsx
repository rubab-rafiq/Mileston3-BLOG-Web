...
//  const querry = `*[_type=='post' && slug.current== "${slug}"]
// {
//   title,summary,image,content,
//     author->{bio,image,name}
// }[0]`
// const post = await client.fetch(querry);
...
//        {/* Main Body of Blog */}
//       <section className="text-lg leading-normal text-dark/80 dark:text-light/80">       <PortableText value={post.content} />
//       </section>
//      </article>
//    );
//  }}
